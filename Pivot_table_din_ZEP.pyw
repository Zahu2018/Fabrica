# pivot table, zep, centralizator un zep
# Centralizeaza datele dintr-un zep
# 29.05.2019
# Zah Florian
...
# Facem un dictionar cu Serafil
	...
	for item in dicti:
		...
		listare += str(lis) +'\n'
	print(listare)
	nume_fila_rezultat = "Centralizator " + str(tail)
	var=open(nume_fila_rezultat, 'w') #numerele trebuie convertite in siruri inainte de scriere in fisier [str()]
	var.write(listare) 
	var.close()
